...
stateDiagram-v2
    ...
    Offered --> PartyAConfirmed: A 确认
    Offered --> PartyBConfirmed: B 确认
    PartyAConfirmed --> Ready: B 确认且版本相同
    PartyBConfirmed --> Ready: A 确认且版本相同
    PartyAConfirmed --> Draft: 草案改变
    PartyBConfirmed --> Draft: 草案改变
